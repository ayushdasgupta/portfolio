...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ayush-dasgupta-809569228",
    color: "#0A66C2",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@ayushdasgupta",
    icon: Github,
    url: "https://github.com/ayushdasgupta",
    color: "#ffffff",
    gradient: "from-[#333] to-[#24292e]"
  }, {
    name: "X",
    displayName: "X",
    subText: "@ayushdasgupta01",
    icon: X,
    url: "https://x.com/ayushdasgupta01",
    color: "#ffffff",
    gradient: "from-[#333] to-[#24292e]"
  }
];
